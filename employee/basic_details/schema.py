...
class PersonalDetailInputSchema(Schema):
    id: Optional[int] = None  # Optional, as it will be auto-generated by the database
    fullname: Dict[str, str]
    date_of_birth: date
    place_of_birth: str
    gender: str
    ...
    total_experiance: Optional[int] = None
